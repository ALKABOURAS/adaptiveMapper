...
def run_2d_cardiogram():
    ...
    print("⚖️ Auto-calibrating... Please stay still for 2 seconds.")
    time.sleep(2)
    ...
    print("🚀 LIVE 2-AXIS CARDIOGRAM STARTED!")
    print("-----------------------------------")
    print("🔵 Blue: Kalman (R=10) -> Smooth but Laggier")
    print("🟢 Green: 1€ Filter (beta=4) -> Fast & Smooth")
    print("-----------------------------------")
