...
def build_registry(rate_hz: float = 200.0) -> dict[str, ScalarFilter]:
    ...
    return {
        ...
        "F7": ConstantVelocityKalman(process_var=1e3, measurement_var=4.0),
        "F8": AdaptiveKalman(process_var=1e2, measurement_var=4.0, speed_coupling=0.05),
